...
(function() {
    ...
    function ModalController($modal) {
        ...
        function activate() {
          ...
          vm.open = function (size, templateUrl) {
...
(function() {
    ...
    function SweetAlertController(SweetAlert) {
        ...
        function activate() {
          ...
          //Custom Functions
          vm.beginInspection = function() {
            SweetAlert.swal({   
              title: 'Start Inspection?',   
              text: 'Hit yes below to begin inspection',   
              type: 'success',
              showCancelButton: true,   
              confirmButtonColor: '#27c24c',
              confirmButtonText: 'Begin Inspection',
              closeOnConfirm: false
            },  function(){ 
                SweetAlert.swal('Begin inspection form');
            });
          };
			...
			debugger;
              ...
              $http
                ...
                .then(function(response) {
				  ...
				  if (vm.account.email == "writer@tekmetric.com") {
				   localStorage.setItem("mode", "writer");
				   
					  window.location="/sparkplug/backend-angular/#/app/writer-appointments";
					
					 
				  }	else if (vm.account.email == "tech@tekmetric.com") {
				  localStorage.setItem("mode", "tech");
					  window.location="/sparkplug/backend-angular/#/app/technician-assignments";
			
					  
				  }	else if (vm.account.email == "customer@tekmetric.com") {
				  localStorage.setItem("mode", "customer");
					  window.location="/sparkplug/backend-angular/#/app/customer-profile";
					  
				  }	else if (vm.account.email == "admin@tekmetric.com") {
				   localStorage.setItem("mode", "admin");
					  window.location="/sparkplug/backend-angular/#/app/admin-dashboard";
					 
				  }	else if (vm.account.email == "dashboard@tekmetric.com") {
				  	  localStorage.setItem("mode", "dashboard");	
					  window.location="/sparkplug/backend-angular/#/app/dashboard";
...
(function() {
    ...
    function settingsRun($rootScope, $localStorage){
      ...
      $rootScope.app = {
        name: 'Tekmetric',
        description: 'Tekmetric Automotive Solutions',
...
(function() {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          // 
          // New templates 08-24-2015
          //
          
          .state('app.writer-appointments', {
              url: '/writer-appointments',
              title: 'Writer Appointments',
              controller: 'ModalController as mod',
              templateUrl: helper.basepath('writer-appointments.html'),
              resolve: helper.resolveFor('jquery-ui', 'jquery-ui-widgets', 'moment', 'fullcalendar', 'xeditable')
          })
          .state('app.writer-services', {
              url: '/writer-services',
              title: 'Writer Services',
              controller: 'ModalController as mod',
              templateUrl: helper.basepath('writer-services.html'),
              resolve: helper.resolveFor('jquery-ui', 'jquery-ui-widgets', 'moment', 'fullcalendar', 'xeditable')
          })
          .state('app.writer-repository', {
              url: '/writer-repository',
              title: 'Writer Repository',
              controller: 'ModalController as mod',
              templateUrl: helper.basepath('writer-repository.html'),
              resolve: helper.resolveFor('datatables')
          })
          .state('app.writer-tech-management', {
              url: '/writer-tech-management',
              controller: 'ModalController as mod',
              title: 'Writer Technician Management',
              templateUrl: helper.basepath('writer-tech-management.html')
          })
          .state('app.writer-tech-management-old', {
              url: '/writer-tech-management-old',
              title: 'Writer Technician Management Old',
              templateUrl: helper.basepath('writer-tech-management-old.html')
          })
          .state('app.writer-customer-management', {
              url: '/writer-customer-management',
              title: 'Writer Customer Management',
              controller: 'ModalController as mod',
              templateUrl: helper.basepath('writer-customer-management.html'),
              resolve: helper.resolveFor('datatables')
          })
          .state('app.inventory-management-products', {
              url: '/inventory-management-products',
              title: 'Inventory Management Products',
              templateUrl: helper.basepath('inventory-management-products.html'),
              resolve: helper.resolveFor('datatables')
          })
          .state('app.inventory-management-orders', {
              url: '/inventory-management-orders',
              title: 'Inventory Management Orders',
              controller: 'ModalController as mod',
              templateUrl: helper.basepath('inventory-management-orders.html'),
              resolve: helper.resolveFor('datatables')
          })
          .state('app.technician-assignments', {
              url: '/technician-assignments',
              title: 'Technician Assignments',
              controller: 'ModalController as mod',
              templateUrl: helper.basepath('technician-assignments.html'),
              resolve: helper.resolveFor('datatables')
          })
          .state('app.technician-inspections', {
              url: '/technician-inspections',
              title: 'Technician Inspections',
              controller: 'SweetAlertController as sweetalert',
              templateUrl: helper.basepath('technician-inspections.html'),
              resolve: helper.resolveFor('datatables', 'oitozero.ngSweetAlert')
          })
          .state('app.customer-profile', {
              url: '/customer-profile',
              title: 'Customer Profile',
              templateUrl: helper.basepath('customer-profile.html'),
              resolve: helper.resolveFor('jquery-ui', 'jquery-ui-widgets', 'moment', 'fullcalendar', 'xeditable', 'loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          .state('app.customer-appointments-service', {
              url: '/customer-appointments-service',
              title: 'Customer Appointments Service',
              controller: 'ModalController as mod',
              templateUrl: helper.basepath('customer-appointments-service.html'),
              resolve: helper.resolveFor('datatables')
          })
          .state('app.customer-schedule-service', {
              url: '/customer-schedule-service',
              title: 'Customer Schedule Service',
              templateUrl: helper.basepath('customer-schedule-service.html'),
              resolve: helper.resolveFor('datatables', 'loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          .state('app.customer-service-history', {
              url: '/customer-service-history',
              title: 'Customer Service History',
              templateUrl: helper.basepath('customer-service-history.html'),
              resolve: helper.resolveFor('datatables', 'ui.grid')
          })
          .state('app.writer-hours', {
              url: '/writer-hours',
              title: 'Writer Hours',
              templateUrl: helper.basepath('writer-hours.html'),
              resolve: helper.resolveFor('datatables', 'jquery-ui', 'ui.grid', 'jquery-ui-widgets', 'moment', 'fullcalendar', 'xeditable')
          })
          .state('app.technician-hours', {
              url: '/technician-hours',
              title: 'Technician Hours',
              templateUrl: helper.basepath('technician-hours.html'),
              resolve: helper.resolveFor('datatables', 'jquery-ui', 'ui.grid', 'jquery-ui-widgets', 'moment', 'fullcalendar', 'xeditable')
          })
...
debugger;
		// Start: BAG
		if (localStorage.getItem("mode") == "writer") {
			  login_menu = "server/sidebar-menu-writer.json"
		  }	else if (localStorage.getItem("mode") == "tech") {
			  login_menu = "server/sidebar-menu-technician.json"
		  }	else if (localStorage.getItem("mode") == "customer") {
			  login_menu = "server/sidebar-menu-customer.json"
		  }	else if (localStorage.getItem("mode") == "admin") {
			  login_menu = "server/sidebar-menu-admin.json"
		  }	else if (localStorage.getItem("mode") == "dashboard") {
			  login_menu = "server/sidebar-menu.json"			  
		  }	else {
			  login_menu = "server/sidebar-menu.json"			
		  }			  
		// End: BAG
